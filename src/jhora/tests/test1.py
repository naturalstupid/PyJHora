...
OUTPUT_FILE = os.path.join(BASE_DIR, "geonames_places_500.csv")
...
# Example: India, USA
ALLOW_ZERO_POP_COUNTRIES = {"IN"}#{"IN"}
...
def build_output_csv(
    ...
    for i, chunk in enumerate(chunk_iter, start=1):
        ...
        if include_alternate_names:
            insert_pos = 2 if (include_ascii_name and not use_ascii_name_as_place_name) else 1
            selected_cols.insert(insert_pos, "alternatenames")
