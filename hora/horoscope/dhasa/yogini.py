...
def get_yogini_dhasa_bhukthi(dob,tob,place,include_antardhasa=True):
    """
        ...
        for _ in range(len(dhasa_adhipathi_list)):
            ...
            if include_antardhasa:
                ...
                for bhukthi_lord in bhukthis:
                    y,m,d,h = utils.jd_to_gregorian(start_jd+timezone)
...
if __name__ == "__main__":
    ...
    jd = utils.julian_day_number(dob, tob)
    yd = get_yogini_dhasa_bhukthi(dob,tob,place,include_antardhasa=False)
    jd1 = utils.julian_day_number((1996,11,21), (19,50,18))
    print(yd)
