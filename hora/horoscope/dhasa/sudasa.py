...
def sudasa_dhasa_bhukthi(dob,tob,place,divisional_chart_factor=1):
    ...
    return sudasa_dhasa_from_planet_positions(planet_positions,sree_lagna_house,sree_lagna_longitude,dob)
def sudasa_dhasa_from_planet_positions(planet_positions,sree_lagna_house,sree_lagna_longitude,dob):
    """
    ...
    """ TODO: using datetime will not work for BCE dates and gives exception """
    ...
    #print('dhasa_start_remaining',dhasa_start_remaining)
    #dhasa_end = dhasa_start+datetime.timedelta(days=dhasa_start_remaining)
    dhasa_end = utils.next_panchanga_day(dhasa_start,add_days=dhasa_start_remaining)
...
if __name__ == "__main__":
    ...
    sd = sudasa_dhasa_bhukthi(dob, tob, place, divisional_chart_factor=1)
    print(sd)    
