...
def get_dhasa_antardhasa(dob,tob,place,divisional_chart_factor=1,years=1,months=1,sixty_hours=1,include_antardasa=True,
    ...
    for lord in dhasa_progression:
        ...
        if include_antardasa:
            ...
            dhasa_start = utils.jd_to_gregorian(start_jd)
            dhasas.append((lord,bhukthis,dhasa_start,dd))
...
if __name__ == "__main__":
    ...
    ld = get_dhasa_antardhasa(dob, tob, place,include_antardasa=True)
    for l,b,d,t in ld:
        print(house.rasi_names_en[l],house.rasi_names_en[b],d)
