...
def _get_dhasa_progression(lunar_longitude):
    nakshatra,paadham,_ = panchanga.nakshatra_pada(lunar_longitude)
    nakshatra -= 1
    paadham -= 1
    dhasa_progression = []
    kalachakra_index = 0
    ...
    if paadham==3:
        kalachakra_index_next = (kalachakra_index+1)%4
        print('kalachakra_index',kalachakra_index,'paadham',paadham)
