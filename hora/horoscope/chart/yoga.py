...
def get_yoga_details(jd,place,divisional_chart_factor=1,language='en'):
    ...
    for yoga_function,details in msgs.items():
        ...
        yoga_exists = eval(yoga_function)(h_to_p)#(planet_positions)#
        if yoga_exists:
...
""" Sun Yogas """
def vesi_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return yp
def vosi_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    yp = str(1) not in yoga_house_planets and ((len(yoga_house_planets) == 1 and const._ascendant_symbol not in yoga_house_planets) or len(yoga_house_planets) > 1)
    return yp
def ubhayachara_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    """ Ubhayachara  Yoga - There is a planet other than Moon in the 2nd and 12th house from Sun. """
    yp = vesi_yoga(h_to_p) and vosi_yoga(h_to_p)
    return yp
def nipuna_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return nipuna_yoga
budha_aaditya_Yoga = lambda h_to_p:nipuna_yoga(h_to_p)
def sunaphaa_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return yp
def anaphaa_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return yp
    return anaphaa_yoga
def duradhara_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    """ Duradhara Yoga - There is a planet other than Sun in the 2nd and 12th house from Moon. """
    return sunaphaa_yoga(h_to_p) and anaphaa_yoga(h_to_p)
def kemadruma_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    #print(ky2)
    return ky1 and ky2
def chandra_mangala_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
...
def adhi_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return adhi_yoga
def ruchaka_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return ruchaka_yoga
def bhadra_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return bhadra_yoga
def sasa_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return sasa_yoga
def maalavya_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
...
def hamsa_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
...
def maalaa_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return maalaa_yoga
def sarpa_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return sarpa_yoga
def gadaa_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return gadaa_yoga
def sakata_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return sakata_yoga
def vihanga_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return vihanga_yoga
def sringaataka_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
...
def hala_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return hala_yoga
def vajra_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return vajra_yoga
def yava_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return yava_yoga
def kamala_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return kamala_yoga
def vaapi_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return vaapi_yoga
def yoopa_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return yoopa_yoga
def sara_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return sara_yoga
def sakti_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return sakti_yoga
def danda_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return danda_yoga
def naukaa_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return naukaa_yoga
def koota_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return koota_yoga
def chatra_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return chatra_yoga
def chaapa_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return chaapa_yoga
def ardha_chandra_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
...
def chakra_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return chakra_yoga
def samudra_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return samudra_yoga
def veenaa_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
...
def subha_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
    ...
    return subha_yoga
def asubha_yoga(h_to_p):#(h_to_p,p_to_h,asc_house):
...
def parvata_yoga(h_to_p):    
    ...
    #print('chk2',chk2)
    return py1 and py2
def kaahala_yoga(h_to_p):
    """ Kaahala Yoga: If (1) the 4th lord and Jupiter are in mutual quadrants and (2) lagna lord is strong """
    p_to_h = utils.get_planet_to_house_dict_from_chart(h_to_p)
    asc_house = p_to_h[const._ascendant_symbol]
    fourth_lord = house.house_owner(h_to_p,(asc_house+3)%12)
    lagna_lord = house.house_owner(h_to_p,asc_house)
...
def sankha_yoga(h_to_p):
    ...
    p_to_h = utils.get_planet_to_house_dict_from_chart(h_to_p)
    asc_house = p_to_h[const._ascendant_symbol]
    fifth_lord = house.house_owner(h_to_p,(asc_house+4)%12)
...
def khadga_yoga(h_to_p):
    ...
    p_to_h = utils.get_planet_to_house_dict_from_chart(h_to_p)
    asc_house = p_to_h[const._ascendant_symbol]
    second_lord = house.house_owner(h_to_p,(asc_house+1)%12)
    ninth_lord = house.house_owner(h_to_p,(asc_house+8)%12)
    lagna_lord = house.house_owner(h_to_p,asc_house)
...
def kalpadruma_yoga(h_to_p):
    ...
    # Comment this for actual """
    lagna_lord = house.house_owner(h_to_p,asc_house)
    depositor_1 = house.house_owner(h_to_p,p_to_h[lagna_lord])
    depositor_2 = house.house_owner(h_to_p,p_to_h[depositor_1])
    depositor_3 = house.house_owner(h_to_p,p_to_h_navamsa[depositor_1])
...
def brahma_yoga(h_to_p):
    ...
    ly2 = p_to_h[4] in quadrants_of_the_house(p_to_h[house.house_owner(h_to_p,(asc_house+8)%12)])
    ly3 = p_to_h[5] in quadrants_of_the_house(p_to_h[house.house_owner(h_to_p,(asc_house+10)%12)])
    ly4_1 = p_to_h[3] in quadrants_of_the_house(p_to_h[house.house_owner(h_to_p,(asc_house)%12)])
    ly4_2 = p_to_h[3] in quadrants_of_the_house(p_to_h[house.house_owner(h_to_p,(asc_house+9)%12)])
    return ly1 or (ly2 and ly3 and (ly4_1 or ly4_1))
def vishnu_yoga(h_to_p):
    ...
    p_to_h = utils.get_planet_to_house_dict_from_chart(h_to_p)
    asc_house = p_to_h[const._ascendant_symbol]
    ninth_lord_in_rasi = house.house_owner(h_to_p,(asc_house+8)%12) 
    vy1 = p_to_h[ninth_lord_in_rasi]==(asc_house+1)%12 and p_to_h[house.house_owner(h_to_p,(asc_house+9)%12)]==(asc_house+1)%12
    if not vy1:
        return False
    lord_of_ninth_in_navamsa = house.house_owner(h_to_p,p_to_h_navamsa[ninth_lord_in_rasi])
    vy2 = p_to_h[lord_of_ninth_in_navamsa] == (asc_house+1)%12
    return vy1 and vy2
def siva_yoga(h_to_p):
...
def gouri_yoga(h_to_p):
    ...
    p_to_h = utils.get_planet_to_house_dict_from_chart(h_to_p)
    asc_house = p_to_h[const._ascendant_symbol]
    navamsa_lord = house.house_owner(h_to_p,asc_house_navamsa)
    rasi_lord = house.house_owner(h_to_p,asc_house)
...
def chandikaa_yoga(h_to_p):
    ...
    sixth_lord_owner_in_navamsa = house.house_owner(h_to_p,p_to_h_navamsa[sixth_lord])
    ninth_lord_owner_in_navamsa = house.house_owner(h_to_p,p_to_h_navamsa[ninth_lord])
    cy2 = p_to_h[0] == p_to_h[sixth_lord_owner_in_navamsa] and p_to_h[0] == p_to_h[ninth_lord_owner_in_navamsa]
    return cy1 and cy2
def lakshmi_yoga(h_to_p):
...
def saarada_yoga(h_to_p):
    ...
    p_to_h = utils.get_planet_to_house_dict_from_chart(h_to_p)
    asc_house = p_to_h[const._ascendant_symbol]
    sy1 = p_to_h[house.house_owner(h_to_p,(asc_house+9)%12)]==(asc_house+4)%12
    if not sy1:
        return False
...
def bhaarathi_yoga(h_to_p):
    ...
    second_lord = house.house_owner(h_to_p,(asc_house+1)%12)
    fifth_lord = house.house_owner(h_to_p,(asc_house+4)%12)
    eleventh_lord = house.house_owner(h_to_p,(asc_house+10)%12)
    ninth_lord = house.house_owner(h_to_p,(asc_house+8)%12)
    navamsa_lords = [house.house_owner(h_to_p,p_to_h_navamsa[second_lord]),house.house_owner(h_to_p,p_to_h_navamsa[fifth_lord]),
                     house.house_owner(h_to_p,p_to_h_navamsa[eleventh_lord])]
...
def devendra_yoga(h_to_p):
    ...
    if not dy1:
        return False
    dy2 = p_to_h[house.house_owner(h_to_p,(asc_house+1)%12)] == (asc_house+9)%12 and p_to_h[house.house_owner(h_to_p,(asc_house+9)%12)] == (asc_house+1)%12
    if not dy2:
        return False
    dy3 = p_to_h[house.house_owner(h_to_p,asc_house)] == (asc_house+10)%12 and p_to_h[house.house_owner(h_to_p,(asc_house+10)%12)] == asc_house
    return dy1 and dy2 and dy3
def indra_yoga(h_to_p):
    ...
    if not iy1:
        return False
    iy2 = p_to_h[house.house_owner(h_to_p,(asc_house+4)%12)] == (asc_house+10)%12 and p_to_h[house.house_owner(h_to_p,(asc_house+10)%12)] == (asc_house+4)%12
    return iy1 and iy2
def ravi_yoga(h_to_p):
    ...
    if not ry1:
        return False
    ry2 = p_to_h[house.house_owner(h_to_p,(asc_house+9)%12)] == (asc_house+2)%12 and p_to_h[6] == (asc_house+2)%12
    return ry1 and ry2 
def bhaaskara_yoga(h_to_p):
...
def gandharva_yoga(h_to_p):
    ...
    asc_house = p_to_h[const._ascendant_symbol]
    lagna_lord = house.house_owner(h_to_p,asc_house)
    gy1 = p_to_h[house.house_owner(h_to_p,(asc_house+9)%12)] in house.trines_of_the_raasi((asc_house+6)%12)
    if not gy1:
        return False
...
def chapa_yoga(h_to_p):
    """ Chapa Yoga: If (1) the 4th and 10th lords have an exchange and (2) lagna lord is exalted. """
    p_to_h = utils.get_planet_to_house_dict_from_chart(h_to_p)
    asc_house = p_to_h[const._ascendant_symbol]
    cy1 = p_to_h[house.house_owner(h_to_p,(asc_house+3)%12)] == (asc_house+9)%12 and p_to_h[house.house_owner(h_to_p,(asc_house+9)%12)] == (asc_house+3)%12
    lagna_lord = house.house_owner(h_to_p,asc_house)
    cy2 = const.house_strengths_of_planets[lagna_lord][p_to_h[lagna_lord]] > const._FRIEND
    return cy1 and cy2
def pushkala_yoga(h_to_p):
    ...
    dispositor_of_moon = house.house_owner(h_to_p,moon_house)
...
def harsha_yoga(h_to_p):
    ...
    p_to_h = utils.get_planet_to_house_dict_from_chart(h_to_p)
    asc_house = p_to_h[const._ascendant_symbol]
    return p_to_h[house.house_owner(h_to_p,(asc_house+5)%12)] == (asc_house+5)%12
def sarala_yoga(h_to_p):
    """ Sarala Yoga: If the 8th lord occupies the 8th house """
    p_to_h = utils.get_planet_to_house_dict_from_chart(h_to_p)
    asc_house = p_to_h[const._ascendant_symbol]
    return p_to_h[house.house_owner(h_to_p,(asc_house+7)%12)] == (asc_house+7)%12
def vimala_yoga(h_to_p):
    """ Vimala Yoga: If the 12th lord occupies the 12th house """
    p_to_h = utils.get_planet_to_house_dict_from_chart(h_to_p)
    asc_house = p_to_h[const._ascendant_symbol]
    return p_to_h[house.house_owner(h_to_p,(asc_house+11)%12)] == (asc_house+11)%12
if __name__ == "__main__":
    h_to_p = ['','1/0','L','','2/3','','4/5','6/7','','8','','']
    kemadruma_yoga(h_to_p)