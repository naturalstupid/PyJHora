...
def _antardhasa(lord):
    ...
    return _bhukthis
def _dhasa_start(jd,place,star_position_from_moon=1,divisional_chart_factor=1,seed_star=22,dhasa_starting_planet=1):
...
def get_dhasa_bhukthi(dob,tob,place,include_antardhasa=True,star_position_from_moon=1,use_tribhagi_variation=False,
                      divisional_chart_factor=1,seed_star=22,dhasa_starting_planet=1):
    """
